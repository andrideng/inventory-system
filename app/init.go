...
// middleware will populate RequestContext, handle possible panics and errors from the processing
...
// GetRequestScope return the RequestScope of the current request.
